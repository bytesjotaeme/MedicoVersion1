...
urlpatterns = [
    # URLs de la App Interna
    path('dashboard/', views.lista_pacientes, name='lista_pacientes'), # Cambiamos la ruta principal interna
    ...
    # AÑADE LAS NUEVAS URLS PARA EL PORTAL PÚBLICO
